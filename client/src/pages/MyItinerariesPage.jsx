...
function ItineraryCard({ itinerary, index, onDelete }) {
  ...
  return (
    <motion.div
      ...
      className="group bg-white rounded-2xl p-5 border border-gray-100 hover:shadow-lg hover:border-orange-200 transition-all"
    >
      <div
      ...
      <button
        onClick={(e) => {
          e.stopPropagation();
          navigate(`/bookNow?itineraryId=${itinerary._id}`);
        }}
        className="w-full mt-4 px-4 py-2.5 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-xl transition-colors text-sm"
      >
        Book Now
      </button>
    </motion.div>
